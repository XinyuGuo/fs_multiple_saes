...
function [opttheta]= trainviusal(time,trainingset,trainingtimes)
...
%      squa red error term of the cost function.  Implement backpropagation to 
...
[cost, grad] = sparseAutoencoderCost(theta, visibleSize, hiddenSize, lambda, ...
                                     sparsityParam, beta, trainingset);
...
options.maxIter = trainingtimes;	  % Maximum number of iterations of L-BFGS to run 
options.display = 'on';
