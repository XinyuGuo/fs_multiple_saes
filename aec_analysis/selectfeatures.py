...
selectedhfeatures = getHogFeatures(featureset)
...
biasname = 'b1'
hogfeaturesname = 'hogfeatures'
selectedhname = 'selectedhfeatures'

fpath = fileprefix+'features.mat'#'./aeccost_10000/features.mat'
bpath = fileprefix+'b1.mat'#'./aeccost_10000/b1.mat'
hogpath= fileprefix + 'hogfeatures.mat'
selectedhogpath = fileprefix + 'selectedhogfeatures.mat'

importer.savemat(fpath,{featurename:featureset})
importer.savemat(bpath,{biasname:b1})
importer.savemat(hogpath,{hogfeaturesname:hogfeatures});
importer.savemat(selectedhogpath,{selectedhname:selectedhfeatures});
